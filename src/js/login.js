window.onload = function() {
    ...
    user_input.onfocus = function() {
        // login_avatar.style.backgroundImage = `url(${GLOBAL.homeSourceUrl}/img/login_greeting.png)`
        login_avatar.className = "greeting"
    };
    user_input.onblur = function() {
        // login_avatar.style.backgroundImage = `url(${GLOBAL.homeSourceUrl}/img/login_normal.png)`
        login_avatar.className = "normal"
    };
    pass_input.onfocus = function() {
        // login_avatar.style.backgroundImage = `url(${GLOBAL.homeSourceUrl}/img/login_blindfold.png)`
