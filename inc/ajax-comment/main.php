...
if(!function_exists('fa_ajax_comment_scripts')) :
    ...
    function fa_ajax_comment_scripts(){
        ...
        wp_enqueue_style( 'ajax-comment', KL_URI . '/ajax-comment/app.css', array(), AC_VERSION );
        wp_enqueue_script( 'ajax-comment', KL_URI . '/ajax-comment/app.js', array( 'jquery' ), AC_VERSION , true );
