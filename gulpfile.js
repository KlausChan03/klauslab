...
let COPYJS = [dir.src + '/js/**/*.min.js',dir.src + '/js/page/*.js',dir.src + '/js/component/*.js', dir.src + '/js/**/canvas.js', dir.src + '/js/**/fixed-plugins.js', dir.src + '/js/util.js', dir.src+ '/js/login.js'];
