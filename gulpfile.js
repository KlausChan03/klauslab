...
let COPYJS = [dir.src + '/js/**/*.min.js',dir.src + '/js/page/*.js',dir.src + '/js/plugin/*.js',dir.src + '/js/component/*.js',dir.src + '/js/mixin/*.js', dir.src + '/js/**/canvas.js', dir.src + '/js/**/fixed-plugins.js', dir.src + '/js/flexible.js', dir.src+ '/js/login.js'];
