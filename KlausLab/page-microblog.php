            ...
            <?php 
                ...
                if ( have_posts() ) { 
                    while ( have_posts() ) { 
                        the_post(); 
            ?>
                <li class="timeline-li flex-hb-vt <?php $author = get_the_author_meta('user_nicename'); if($author == "klaus") { echo 'author-by-klaus'; } else if($author == "laura") { echo 'author-by-laura'; } ?>">
                    <div class="icon">
